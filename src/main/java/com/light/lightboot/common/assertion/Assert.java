...
public interface Assert {
     ...
     *
     * @param obj 待判断对象
     * @param errMsg 自定义的错误信息. 支持 {index} 形式的占位符,
     *               比如: errMsg-用户[{0}]不存在, args-1001, 最后打印-用户[1001]不存在
     * @param args message占位符对应的参数列表
     */
    ...
    /**
     * <p>断言字符串<code>str</code>不为空串（长度为0）</p>
     * 如果字符串<code>str</code>为空串，则抛出异常
     *
     * @param str 待判断字符串
     * @param errMsg 自定义的错误信息
     */
    ...
    /**
     * <p>断言集合<code>c</code>不为空。如果集合<code>c</code>为空，则抛出异常
     *
     * @param c 待判断数组
     */
    ...
    /**
     * <p>断言Map<code>map</code>不为空。如果Map<code>map</code>为空，则抛出异常
     *
     * @param map 待判断Map
     */
